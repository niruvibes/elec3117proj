...
INPUT = ROOT / "tmp/layout-analysis/project.vddd-stage.kicad_pcb"
OUTPUT = ROOT / "tmp/layout-analysis/project.finalized3.kicad_pcb"


def main() -> int:
    board = pcbnew.LoadBoard(str(INPUT))
    source = xy(board.FindFootprintByReference("U1").FindPadByNumber("25").GetPosition())
